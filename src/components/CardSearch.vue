<template>
    <div class="search-form">
        <div class="col">
            ...
            <input id="player" v-model.trim="player">
            ...
            <select id="pos" v-model="pos" multiple="multiple">
            ...
            <select id="shoots" v-model="shoots">
                <option>Any</option>
                <option>Left</option>
                <option>Right</option>
            </select>
            ...
            <select id="hgt" v-model="hgt" multiple="multiple">
            ...
            <select id="synergy" v-model="synergy" multiple="multiple">
        ...
        <div class="col">
            ...
            <label for="ovrmin">Ovrmin</label>
            <input id="ovrmin" v-model.number="ovrmin">

            <label for="ovrmax">Ovrmax</label>
            <input id="ovrmax" v-model.number="ovrmax">
            ...
            <select id="stype" v-model="stype" multiple="multiple">
            ...
            <label for="scard">Card</label>
            <select id="scard" v-model="scard" multiple="multiple">
            ...
            <label for="wgtmin">Ovrmin</label>
            <input id="wgtmin" v-model.number="wgtmin">

            <label for="wgtmax">Ovrmax</label>
            <input id="wgtmax" v-model.number="wgtmax">
        ...
        <div class="synergy-list">
            <div v-if="synergy.includes(syn.name)" v-for="(syn, index) in synergyRate" v-bind:key="syn.id">
                    {{ syn.name }} - {{ syn.rate }}
                    <button v-on:click="synDec(syn.id)">-</button>
                    <button v-on:click="synInc(syn.id)">+</button>
            </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            search: function () {
                this.makeUrl();
                fetch(this.proxyurl + this.request)
                    .then(response => response.text())
                    .then(contents => {
                        this.results = JSON.parse(contents);
                        this.results.shift();
                    })
                    .catch(() => console.log("Cant access " + this.request + " response. Blocked by browser?"))
            },
            makeUrl: function () {
